...
description: Wire OMem into your agent — exact steps for Claude Code, Codex, Claw Hub, and any MCP client (Cursor, Cline, …). One skill, several front doors; the omem mcp server as the universal fallback.
---
